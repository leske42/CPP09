...
/*   Updated: 2024/09/22 14:47:52 by mhuszar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void BitcoinExchange::displayResult(std::string& line, float coins, float result)
{
    while (line[line.size() - 1] != '|')
        line.erase(line.size() - 1, 1);
    line.erase(line.size() - 1, 1);
    std::cout << line << "=> " << coins << " = " << result << std::endl;
}
